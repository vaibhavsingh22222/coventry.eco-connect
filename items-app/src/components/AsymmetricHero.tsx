            ...
            <div className="relative bg-white p-4 rounded-3xl shadow-2xl border border-slate-100 rotate-2 hover:rotate-0 transition-transform duration-500">
               <div className="bg-slate-900 rounded-2xl overflow-hidden p-1 shadow-inner">
                  ...
                  <div className="p-6 pt-0 font-mono text-sm space-y-2">
                    <p className="text-green-400">const <span className="text-white">Business</span> = {"{"}</p>
                    <p className="pl-4 text-slate-400">category: [<span className="text-emerald-400">'Zero-Waste', 'Repair', 'Local'</span>],</p>
                    <p className="pl-4 text-slate-400">location: <span className="text-amber-400">'Coventry'</span>,</p>
                    <p className="pl-4 text-slate-400">rating: <span className="text-emerald-400">5</span></p>
